...
The image will be released when it matches the date of the requester
(although the image will only consider rendering if it is a Monday. That will be fixed soon)
...
Copyright (c) 2012 Simon Orr. See LICENSE.txt for
further details.
